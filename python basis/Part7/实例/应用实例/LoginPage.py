...
class LoginPage(object):
    ...
    def createPage(self):
        ...
        self.page.pack()
        Label(self.page,text='招生人数查询系统',bg='#d3fbfb',fg='red',font=('宋体',25),relief=SUNKEN).grid(row=1,columnspan=2,sticky=E+W)
        ...
        Entry(self.page,textvariable=self.password,show='*').grid(row=4,column=1,sticky=W)
        Button(self.page, text='登录',font=('宋体',10),command=self.loginCheck).grid(row=5,columnspan=2,sticky=W,padx=50,pady=10)
        Button(self.page, text='退出',font=('宋体',10),command=self.root.destroy).grid(row=5,columnspan=2,sticky=E,padx=50,pady=10)
